...
-- Apps: for each app generate batch files and a project based on kit files (e.g. company_name.app_name.kit)
define_app("deloitte.sample_app")
define_app("deloitte.sample_app.viewport")
define_app("deloitte.sample_app.editor")
